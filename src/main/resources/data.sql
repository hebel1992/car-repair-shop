...
INSERT INTO orders (actual_repair_start, created, initial_diagnosis, planned_repair_start, title, status_id, vehicle_id) VALUES (DATE_ADD(NOW(),INTERVAL -4 DAY), DATE_ADD(NOW(),INTERVAL -5 DAY), 'Oil filter need to be changed', DATE_ADD(NOW(),INTERVAL -4 DAY), 'Oil filter change', 3, 6);
...
INSERT INTO orders (actual_repair_start, created, initial_diagnosis, planned_repair_start, title, status_id, vehicle_id) VALUES (DATE_ADD(NOW(),INTERVAL -2 DAY), DATE_ADD(NOW(),INTERVAL -4 DAY), 'Lights aiming too low, need adjustment', DATE_ADD(NOW(),INTERVAL -3 DAY), 'Lights adjustment', 2, 5);
...
INSERT INTO orders (actual_repair_start, created, initial_diagnosis, planned_repair_start, title, status_id, vehicle_id) VALUES (DATE_ADD(NOW(),INTERVAL -4 DAY), DATE_ADD(NOW(),INTERVAL -5 DAY), 'Oil filter need to be changed', DATE_ADD(NOW(),INTERVAL -4 DAY), 'Oil filter change', 3, 2);
...
INSERT INTO orders (actual_repair_start, created, initial_diagnosis, planned_repair_start, title, status_id, vehicle_id) VALUES (DATE_ADD(NOW(),INTERVAL -6 DAY), DATE_ADD(NOW(),INTERVAL -4 DAY), 'Suspension problem', DATE_ADD(NOW(),INTERVAL -5 DAY), 'Suspension problem', 3, 2);
